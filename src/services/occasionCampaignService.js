...
export const OCCASIONS = [
  { id: 'birthday', name: 'أعياد ميلاد المرضى', description: 'تهنئة عيد الميلاد مع هدية خصم خاصة' },
  { id: 'ramadan', name: 'شهر رمضان المبارك', description: 'عروض العناية والابتسامة الرمضانية' },
  { id: 'eid', name: 'عيد الفطر والأضحى', description: 'استعدادات العيد وتبييض الأسنان والنضارة' },
  { id: 'summer', name: 'موسم الصيف والمناسبات', description: 'جلسات النضارة وباقات الليزر الصيفية' }
];
  ...
  switch (occasionId) {
    case 'birthday':
      return (
        ...
        `طاقم ${clinicName} يتمنى لك عاماً سعيداً مليئاً بالصحة والتوفيق.\n` +
        `احتفالاً بيوم ميلادك، خصصنا لك ميزة حصرية:\n` +

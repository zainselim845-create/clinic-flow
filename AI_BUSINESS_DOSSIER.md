...
graph TD
    ...
    F -->|إملاء صوتي بالعامية/الإنجليزية| G["توثيق الملاحظات وملف الزيارة SOAP"]
...
|---|---|---|---|
| **فحص تعارض الملاحظات السريرية والأدوية** | 350 توكن (الأدوية + الأمراض المزمنة) | 150 توكن (تقرير الأمان والتحذير) | **~ 500 توكن** |
...
3. **التدقيق السريري الصارم (Human-in-the-Loop):**  
   لا يتم اعتماد أي تشخيص أو تقرير طبي أو تغيير موعد تلقائياً دون **موافقة الطبيب النهائية بضغطة زر**، مما يعفي المنظومة من أي مسؤولية تشخيصية مباشرة.
...
### جدول تسعير الباقات وهوامش الربح الإجمالية:

| الباقة | السعر الشهري المقترح | التكلفة التقديرية للـ AI (شهرياً) | هامش الربح الإجمالي (Gross Margin) | المزايا السريرية والتشغيلية المشمولة |
|---|---|---|---|---|
| **Starter (الأساسية)** | **600 ج.م** | ~ 15 ج.م (شات بوت الحجز فقط) | **97.5%** | حجز ذكي، أجندة سحابية، استعلامات المرضى الأساسية. |
| **Pro (المتقدمة)** | **1,200 ج.م** | ~ 45 ج.م (كافة خدمات العيادة) | **96.2%** | كافة مزايا Starter + كاشف تعارض الأدوية + إدارة خطط العلاج + استرجاع الغائبين. |
| **Enterprise (المراكز)** | **2,500 ج.م** | ~ 110 ج.م (متعدد الأطباء) | **95.6%** | مزايا Pro + صلاحيات طاقم متقدمة + فروع متعددة + تقارير استراتيجية حصرية. |

---

## 📈 7. دراسة الأثر المالي على العيادة وعائد الاستثمار (Clinic ROI)

### دراسة حالة واقعية لعيادة خاصة تستقبل 20 كشفاً يومياً:
* **استرداد المرضى المتغيبين (No-Show Recovery):** استرجاع 4 مرضى شهرياً كانوا سيتغيبون (4 × 300 ج.م) ➔ **+1,200 ج.م شهرياً**.
* **تحفيز تقييمات Google Maps:** زيادة عدد الكشوفات الجديدة عبر السمعة الرقمية بمعدل 12 كشف شهرياً ➔ **+3,600 ج.م شهرياً**.
...
2. **الأسبوع 2: تفعيل المساعد السريري:** ربط كاشف تعارض الأدوية، والإملاء الصوتي للملاحظات في شاشة الكشف.
